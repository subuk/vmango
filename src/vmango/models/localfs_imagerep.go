...
func (repo *LocalfsImagerep) List(images *[]*Image) error {
	...
	for _, fileinfo := range files {
		...
		default:
			...
			continue
		case "amd64", "x86-64":
			image.Arch = IMAGE_ARCH_X86_64
		case "i386", "x86":
			image.Arch = IMAGE_ARCH_X86
		}
		switch imginfo[2] {
		default:
...
func (l *LocalfsImagerep) Get(*Image) (bool, error) {
