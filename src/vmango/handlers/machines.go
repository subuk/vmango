...
func MachineDeleteFormShow(ctx *web.Context, w http.ResponseWriter, req *http.Request) error {
...
func MachineDeleteFormProcess(ctx *web.Context, w http.ResponseWriter, req *http.Request) error {
	urlvars := mux.Vars(req)
	providerId := urlvars["provider"]
	machineId := urlvars["id"]
...
func MachineStateChangeFormShow(ctx *web.Context, w http.ResponseWriter, req *http.Request) error {
	urlvars := mux.Vars(req)
	providerId := urlvars["provider"]
	machineId := urlvars["id"]
...
func MachineStateChangeFormProcess(ctx *web.Context, w http.ResponseWriter, req *http.Request) error {
	urlvars := mux.Vars(req)
	providerId := urlvars["provider"]
	machineId := urlvars["id"]
	action := urlvars["action"]
...
func MachineAddFormProcess(ctx *web.Context, w http.ResponseWriter, req *http.Request) error {
...
func MachineAddFormShow(ctx *web.Context, w http.ResponseWriter, req *http.Request) error {
	...
	return ctx.Render.HTML(w, http.StatusOK, "machines/add", map[string]interface{}{
		"Request":   req,
		"Plans":     plans,
		"Images":    images,
		"Providers": providers,
